...
def pulldown():
    ...
    while t:
        ...
        for _ in range(10):
            ...
            # print(soup.select('li.StreamMegaItem a'))
            # links = [a["href"] for a in soup.select("li.StreamMegaItem a[href]")]
            # print(soup.select("li.StreamMegaItem a")[0]["href"])
            # x=BeautifulSoup(soup.select('li.StreamMegaItem a'))
